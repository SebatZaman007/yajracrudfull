        ...
        <div class="card">
			<div class="row">
				<div class="col-md-5 wrapthumbnail">
					<a href="post.html">
						<div class="thumbnail" style="background-image:url({{asset(BlogImage().$item->profile_image)}});">
						</div>
					</a>
				</div>
				<div class="col-md-7">
					<div class="card-block">
						<h2 class="card-title">ID:{{$item->campus_id}}</h2>
						<h4 class="card-text">Name:{{$item->name}}</h4>
						<h4 class="card-text">Subject:{{$item->subject}}</h4>
